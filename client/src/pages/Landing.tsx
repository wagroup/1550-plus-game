      ...
      <header className="max-w-6xl mx-auto flex items-center justify-between px-6 py-5">
        ...
        <nav className="flex items-center gap-3">
          {signedIn ? (
            ...
            <>
              <Link to="/login" className="font-semibold text-slate-600 hover:text-navy px-3 py-2">Teacher Login</Link>
              <Button onClick={() => navigate('/register')}>Create a Game</Button>
            </>
          )}
        </nav>
      </header>
        ...
        <section className="grid md:grid-cols-2 gap-10 items-center py-14">
          <div>
            ...
            <div className="flex flex-wrap gap-4">
              <Button className="text-lg px-6 py-3" onClick={() => navigate(signedIn ? '/create-game' : '/register')}>
                🎮 Create a Game
              </Button>
              <Button variant="secondary" className="text-lg px-6 py-3" onClick={() => navigate('/login')}>
                Teacher Login
              </Button>
            </div>
          </div>
